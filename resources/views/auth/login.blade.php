...
<body class="bg-primary-dark min-h-screen flex items-center justify-center p-4">
    ...
    {{-- 
        O 'border-highlight' aqui garante que a linha do TOPO continue VERMELHA.
    --}}
        ...
        <form action="{{ url('/login') }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    {{-- 
                        MUDANÇA: Usando 'focus:border-blue-700' e 'focus:ring-blue-700'.
                        Isso dá aquele tom de azul mais fechado e elegante.
                    --}}
                    <input 
                        type="email" 
                        id="email" 
                        name="email" 
                        class="w-full p-3 border border-gray-300 rounded-lg outline-none transition-colors focus:border-blue-700 focus:ring-1 focus:ring-blue-700" 
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            id="senha" 
                            name="senha"
                            class="w-full p-3 border border-gray-300 rounded-lg outline-none transition-colors focus:border-blue-700 focus:ring-1 focus:ring-blue-700 pr-10" 
                            placeholder="••••••••"
                            required
